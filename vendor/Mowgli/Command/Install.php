...
The <info>install</info> command will deploy your application in a directory:
    ...
    <info>mowgli install destination_dir</info>
...
EOF
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $fs    = $container['fs'];
        $paths = array(
            'share'          => $installPath . '/share/mowgli',
            'share_launcher' => $installPath . '/share/mowgli/bin/mowgli',
            'bin'            => $installPath . '/bin',
            'bin_launcher'   => $installPath . '/bin/mowgli',
        );
